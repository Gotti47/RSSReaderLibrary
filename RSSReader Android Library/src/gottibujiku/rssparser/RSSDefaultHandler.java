...
public class RSSDefaultHandler extends DefaultHandler {
    ...
    private RSSFeedItem rssFeedItem;//A representation of a single item
    private ArrayList<RSSFeedItem> rssFeedItems;//A collection of all RSS items
    private StringBuilder builder;//a string variable to hold the content between two XML tags


    public RSSDefaultHandler() {

      rssFeedItems = new ArrayList<RSSFeedItem>();
